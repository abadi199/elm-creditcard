...
import Svg exposing (svg, rect, text', text, foreignObject, defs)
import Svg.Attributes as Attributes exposing (width, height, viewBox, x, y, rx, ry, fill, fontSize, fontFamily)
