...
/***/ function(module, exports) {
	...
	var _abadi199$elm_creditcard$CreditCard_View$form = function (model) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_abadi199$elm_creditcard$CreditCard_Components_Card$cardView(model),
	...
	var _abadi199$elm_creditcard$CheckoutFormWithFields$init = {creditCard: _abadi199$elm_creditcard$CreditCard_Model$init, address1: '', address2: '', city: '', state: '', zipCode: ''};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_abadi199$elm_creditcard$CreditCard_Components_Card$cardView(model.creditCard)),
					A2(
					_elm_lang$html$Html$p,
					_elm_lang$core$Native_List.fromArray(
						[
